...
- [crt.sh](https://crt.sh){:target="_blank"}: crt.sh is a Certificate Transparency (CT) log search tool that allows users to find SSL/TLS certificates issued for specific domains or organizations.
